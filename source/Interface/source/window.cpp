...
Window::Window(QWidget *parent) : QWidget(parent)
{
 ...
 {
     s = line->text();
     //Нужно как-то передать полный путь к директории экземпляру класса Сканер,
     //который, в свою очередь нужно создать, так, чтобы Qt не ругался.
     //И когда Сканер закончит свою работу, появится окно, оповещающее об окончании сканирования
     QLabel *indicator1 = new QLabel("Scan Directory? Done!");
...
{
    bool t=true;
    //Нужно как-то передать булево значение экземпляру класса Сканер,
    //который, в свою очередь нужно создать, так, чтобы Qt не ругался.
    //И когда Сканер закончит свою работу, появится окно, оповещающее об окончании сканирования
    QLabel *indicator2 = new QLabel("Scan All? Done!");
